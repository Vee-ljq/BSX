...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="css/shopping-mall-index.css" rel="stylesheet" type="text/css" />

		<link href="basic/css/demo.css" rel="stylesheet" type="text/css" />
		<link type="text/css" href="css/optstyle.css" rel="stylesheet" />
		<link type="text/css" href="css/style.css" rel="stylesheet" />
		<link type="text/css" href="css/style_.css" rel="stylesheet" />
	...
	<div class="hmtop">
			...
			<div class="nav-table">
				...
				<!--优惠套装-->
				<div class="match">
					<div class="match-title">猜你喜欢</div>
						...
						<div class="eva-info3">
							<div class="eva-if3-l f-l">
								...
								<dl class="if3-l-dl3">
									...
									<dd>
										<a href="JavaScript:;">
											<img src="images/dl3-tu1.gif" />
											<input type="file" class="img1" />
										</a>
										<a href="JavaScript:;">
											<img src="images/dl3-tu2.gif" />
											<input type="file" class="img1" />
										</a>
										<p>上传图片     1/5</p>
										<div style="clear:both;"></div>
