...
<body class="childrenBody">
	<form class="layui-form" action="<%=path%>/goodstype/savegoodstype.action" method="post" target="_parent">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="typename" value="" class="layui-input newsName" lay-verify="required" placeholder="请输入类型名称">
			</div>
		</div>
		<div class="layui-form-item">
