...
<html>
	...
	<head>
		...
		<meta name="renderer" content="webkit">
 		...
 		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  		<link rel="stylesheet" href="<%=path %>/js/ace/css/layui2.css"  media="all">
		...
		<link href="<%=path %>/web/css/lostyle.css" rel="stylesheet" type="text/css">
	...
	<body>
				...
				<div class="main-wrap">
					<div class="user-logistics">
						...
						<div class="package-title">
							<div class="m-item">
								<div class="item-pic">
									<img src="<%=path %>/web/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg">
								</div>
								<div class="item-info">
									<p class="log-status">物流状态:<span><c:if test=""></c:if></span> </p>
									<p>承运公司：${kd.company }</p>
									<p>快递单号：${wlno }</p>
						...
						<div class="package-status" id="wlline">
		...
		<%
			 ...
			 <input type="hidden" value="${kd.code}" id="logisticsum">
		<div class="line"></div>

	</body>
	<script src="<%=path %>/js/layui/js/layui2.js" charset="utf-8"></script>
...
$(function(){
  ...
  var logisticsum=$("#logisticsum").val();
   ...
   $.ajax({
            ...
            data: {
            wlno:wlno,
            logisticsum:logisticsum,
            },
            type: "post",
            dataType: "json",
            success: function(result){
              for(var i=0;i<result.Traces.length;i++){
              $("#wlline ul").append("<li class='layui-timeline-item'><i class='layui-icon layui-timeline-axis'>♕</i><div class='layui-timeline-content layui-text'><h3 class='layui-timeline-title'>"+ result.Traces[i].AcceptTime+"</h3></div>"+result.Traces[i].AcceptStation
    +"</div></li>");
              }
