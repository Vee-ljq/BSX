				...
				<div class="main-wrap">
					...
					<div class="user-safety">
						...
						<div class="user-infoPic">
							...
							<div class="info-m">
								<div><b>用户名：<i>${customer.nickname }</i></b></div>
								<div class="u-level">
									<span class="rank r2">
						...
						<div class="check">
							<ul>
								<li>
									...
									<div class="fore3">
										<a href="<%=path%>/web/editpassword.action">
								...
								<li>
									...
									<div class="fore3">
										<a href="<%=path%>/web/editbindphone.action">
								...
								<li>
									...
									<div class="fore3">
										<a href="<%-- <%=path%>/web/editemail.action --%>#">
											<div class="am-btn am-btn-secondary">换绑</div>
										</a>
									</div>
								</li>
								<li>
									...
									<div class="fore3">
										<a href="<%=path%>/web/editidcard.action">
								...
								<li>
									...
									<div class="fore3">
										<a href="#<%-- <%=path%>/web/editquestion.action --%>">
											<div class="am-btn am-btn-secondary">认证</div>
										</a>
									</div>
								</li>
