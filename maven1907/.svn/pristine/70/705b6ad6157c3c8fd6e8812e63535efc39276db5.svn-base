...
<body class="childrenBody">
	<form class="layui-form" action="<%=path%>/goodstype/tjejlx.action" method="post" target="_parent">
		...
		<div class="layui-form-item">
			<label class="layui-form-label" style="width: 85px">添加二级商品类型</label>
			<div class="layui-input-block">
				<input type="text" name="typename" class="layui-input newsName" lay-verify="required" placeholder="请输入二级商品类型名称">
			</div>
		</div>
