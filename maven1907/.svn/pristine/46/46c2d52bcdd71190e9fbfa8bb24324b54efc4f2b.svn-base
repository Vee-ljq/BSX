...
<body class="childrenBody">
	<form class="layui-form" action="<%=path%>/webrzw/rzwsave.action" method="post" target="_parent">
		<input type="hidden" name="id" value="${bb.id }"/>
		<div class="layui-form-item">
			<label class="layui-form-label">软赢科技主题:</label>
			<div class="layui-input-block">
				<input type="text" name="titile" value="${bb.titile }" class="layui-input newsName" lay-verify="required" placeholder="请输入软赢科技主题">
			</div>
		</div>
		
		<div class="layui-form-item">
			<label class="layui-form-label" id="goodsinfolable">软赢科技内容:</label>
			<div class="layui-input-block">
				<input id="content" type="hidden" name="goodsinfo"/>
