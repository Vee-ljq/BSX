						...
						<div class="am-tabs am-tabs-d2" data-am-tabs>
							...
							<div class="am-tabs-bd">
									...
									<div class="news-day">
										...
										<c:forEach items="${activities }" var="activities">
											<div class="s-msg-item s-msg-temp i-msg-downup">
												<h6 class="s-msg-bar"><span class="s-name">${activities.contexttopic }</span></h6>
												<div class="s-msg-content i-msg-downup-wrap">
													<div class="i-msg-downup-con">
														<a class="i-markRead" target="_blank" href="blog.jsp">
															<img src="<%=path %>/web/images/TB102.jpg">
															
															<p class="s-row s-main-content">
																<a href="<%=path %>/web/activitiesInfo.action?activitiesId=${activities.id}">
								...
								<div class="am-tab-panel am-fade" id="tab2">
									...
									<c:if test="${allOrders.status==2 or allOrders.status==3 }">
										<div class="s-msg-item s-msg-temp i-msg-downup">
										<c:if test="${allOrders.status==2 }">
											<h6 class="s-msg-bar"><span class="s-name">订单已发货</span></h6>
										</c:if>
										<c:if test="${allOrders.status==3 }">
											...
											<div class="s-msg-content i-msg-downup-wrap">
												<div class="i-msg-downup-con">
													<a class="i-markRead" target="_blank" href="ogistics.jsp">
													<div class="m-item">	
														<div class="item-pic">															
														...
														<div class="item-info">
															您购买的
															<c:forEach items="${allOrders.orderdetail }" var="orderdetail">"${orderdetail.goods.goodsname }"  </c:forEach>
															已签收，
															快递单号:${allOrders.wlno }
														</div>
