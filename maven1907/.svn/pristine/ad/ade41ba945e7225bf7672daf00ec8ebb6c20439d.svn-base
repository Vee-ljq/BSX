...
<body class="childrenBody">
	<form class="layui-form" action="<%=path%>/role/save.action" method="post" target="_parent">
		<div class="layui-form-item">
			<label class="layui-form-label">角色名称</label>
			<div class="layui-input-block">
				<input type="hidden" name="id" id="id" value="${role.id }"/>
				<input type="text" name="rolename" value="${role.rolename }" class="layui-input newsName" lay-verify="required" placeholder="请输入角色名称">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<select name="status" value="${role.status }">
