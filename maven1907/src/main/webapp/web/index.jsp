		...
		<div class="hmtop">
			...
			<div class="am-container header">
				<ul class="message-l">
					...
					<div class="topMessage">
						<div class="menu-hd">
							...
							<a href="register.action" target="_top">免费注册</a>
						</div>
					</div>
				...
				<div class="nav white">
					...
					<div class="logoBig">
						<li class=""><img src="images/logobig.png" width="159" height="78"></li>
					</div>
															...
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort">
																		...
																		<dd><a title="蒸蛋糕" ><span>蒸蛋糕</span></a></dd>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<a href="hot.jsp"><img src="images/activity1.jpg "></img></a>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>														
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<div class="am-u-sm-7 am-u-md-4 text-two sug">
								...
								<a href="javascript:goodsxq/data.action "><img src="images/2.jpg" /></a>
							</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="goodsxq/data.action  "><img src="images/1.jpg" /></a>
							</div>
