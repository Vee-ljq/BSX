...
<body class="childrenBody">
	<form class="layui-form" action="<%=path%>/news/tjlb.action" method="post" target="_parent">
		<div class="layui-form-item">
			<label class="layui-form-label">添加新闻类别</label>
			<div class="layui-input-block">
				<input type="text" name="newsname"  class="layui-input newsName" lay-verify="required" placeholder="请输入需要的新闻类别">
			</div>
		</div>
