...
<body class="childrenBody">
	...
	<form action="<%=path%>/role/data.action" >
		<div class="layui-inline">
		    <div class="layui-input-inline">
		    	...
		    	<input type="text" value="${role.rolename }"   name="rolename" class="layui-input search_input">
		    </div>
		    		...
		    		<c:otherwise>
		    			<c:forEach items="${page.page.list }" var="org">
		    				<tr>
		    					...
		    					<a class="layui-btn layui-btn-danger layui-btn-mini news_qx" data-id="${org.id }" ><i class="layui-icon">&#xe630;</i> 权限</a>
		    					</td>
		    				</tr>
		    			</c:forEach>
		    		</c:otherwise>
	...
	<script type="text/javascript" src="<%=path %>/js/role/data.js"></script>
