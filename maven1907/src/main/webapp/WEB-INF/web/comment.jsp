...
<link href="<%=path %>/web/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet"
	type="text/css">
<link href="<%=path %>/web/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet"
	type="text/css">

<link href="<%=path %>/web/css/personal.css" rel="stylesheet" type="text/css">
<link href="<%=path %>/web/css/cmstyle.css" rel="stylesheet" type="text/css">
													...
													<li class="td td-item">
														<div class="item-pic">
															<a href="#" class="J_MakePoint"> <img
																src="<%=path%>/upload/${ss.goods.indeximg}"
																class="itempic" alt="暂无图片"> </a>
														</div></li>

													<li class="td td-comment" style="height: 120px">
														<div class="item-title">
															<div class="item-opinion">好评</div>
															<div class="item-name">
																<a href="#">
																	<p class="item-basic-info">${ss.goods.goodsname }</p> </a>
															</div>
														</div>
														<div class="item-comment">${ss.comment }</div>

														<div class="item-info">
															<div>
																<p class="info-little">
																<p class="info-time">${ss.createdate }</p>
