...
<html>
	...
	<head>
		...
		<link href="<%=path %>/web/css/blstyle.css" rel="stylesheet" type="text/css">
                            ...
                            <span class="desc">（金额单位：元）</span>
								...
								<div class=" ng-scope">
									<div class="trade-circle-select  slidedown-">
										<a href="javascript:void(0);" class="current-circle ng-binding">${begin } - ${last }</a>

									</div>
									<span class="title-tag"><i class="num ng-binding">${m }</i>月</span>
								</div>
							</div>
							...
							<div class="module-income ng-scope">
								<div class="income-slider ">
                                    ...
                                    <span class="desc ng-binding">
                                           <a href="<%=path %>/webbill/billlist.action?date=7">查看支出明细</a>
                                         </span>
                                             </h3>
											...
											<div class="catatory-detail fn-left">
												...
												<c:forEach items="${bill }" var="bill">
													<li class="ng-scope  delete-false">
														...
														<div class="  ng-scope">
															<a href="#" class="text fn-left " title="${bill.BGoods.goodsname }">
																<span class="emoji-span ng-binding">${bill.BGoods.goodsname }</span>
																<span class="amount fn-right ng-binding">${bill.BGoods.price }</span>
															</a>
														</div>
													</li>
												</c:forEach>
